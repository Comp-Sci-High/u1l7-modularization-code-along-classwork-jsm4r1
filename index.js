...
function heroAction (hero, power, city) {
    ...
    // retun `${hero} uses ${power} to protect ${city}.`
}

// // Step 4: Call the function below for Spider-Man, Magneto, & Wonder Woman

// let hero1 = heroAction("Spider-man", "web-swinging", "Queens")
// console.log(hero1)

console.log(heroAction("Spider-man", "web-swinging", "Queens"))
console.log(heroAction("Magneto", "Magnetic manipulation", "Genosha"))
console.log(heroAction("Wonder Woman", "super strength", "Themyscira"))
...
console.log(heroAction("Batman", "strength", "Gotham"))
console.log(heroAction("Super man", "invulnerability", "Metropolis"))
...
console.log("Doctor Octopus", "strength", "NYC")
console.log("Electro", "electrokinesis", "NYC")
console.log("Vulture", "flight", "NYC")
console.log("Sandman", "sand manipulation", "NYC")
console.log("Mysterio", "genius intellect", "NYC")
console.log("Kraven the Hunter", "strength", "NYC")
...
function heroVsVillain (secretIdentity, city, affiliation, archNemesis, catchphrase){
    return {
        secretIdentity: "",
        city: "",
        affiliation: "",
...
console.log(heroVsVillain("T'Challa", "Wakanda", "Avengers", "Killmonger", "Wakanda Forever"))
console.log(heroVsVillain("Bruce Wayne", "Gotham City", "Justice League", "Joker", "I am vengance, I am the night, I am Batman"))

// // Step 6: Call the function for Iron Man

console.log(heroVsVillain("Tony Stark", "NYC", "Avengers", "The Mandarin", "I am Iron Man"))
